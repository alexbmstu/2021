...
При реализации в виде аппаратной схемы становится возможным не только построить параллельную структуру для вычисления одного значения функции, но многократно повторить это устройство для параллельного вычисления сразу нескольких значений (_y__0__\=f(x__0__),y__1__\=f(x__1__),y__2__\=f(x__2__),..._).
