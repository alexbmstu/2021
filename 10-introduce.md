...
Запустите тестовой приложение и во вкладке Console будет показана таблица с количеством тактов, затраченных на выполнение задачи на разных ускорительных ядрах.

![](assets/photo_2021-12-11_13-27-46.jpg)

Вывод приложения или копию экрана вкладки Console добавьте в отчет. 
